...
const Sidebar = (props) => {
    ...
    const layout = {Dubai: "compact-wrapper"}
        ...
        <Fragment>
            ...
            <div className="sidebar-wrapper close_icon">
                ...
                <div className="logo-icon-wrapper">
                    <Link to={`${process.env.PUBLIC_URL}/dashboard/default/${layout}`}><img className="img-fluid"
                        ...
                        <ul className="sidebar-links custom-scrollbar">
                            <li className="back-btn">
                                <div className="mobile-back text-right"><span>{"Back"}</span><i
                                    className="fa fa-angle-right pl-2" aria-hidden="true"/></div>
                            </li>
                            {
